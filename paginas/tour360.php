<!-- Tour 360 -->
<div id="tour">
    <section class="gov bg-primary">
        <div class="container">
            <h2 class="text-center text-uppercase mb-0  text-white">Visite um de nossos modelos</h2>
    ...
    <section class="p-0">
        <div class="container-fluid p-0" id="box-toggle2">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 01 )
                                    Casa Com 2 Quartos / Cozinha Americana / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="gov-box" href="https://bit.ly/govpe02">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 02 )
                                    Casa Com 2 Quartos / Cozinha Americana / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="gov-box" href="https://bit.ly/govpe03">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 03 )
                                    Casa Com 2 Quartos / Cozinha Americana / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="gov-box" href="https://bit.ly/govpe04">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 04 )
                                    Casa Com 2 Quartos / Cozinha / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="gov-box" href="https://bit.ly/govpe05">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 05 )
                                    Casa Com 2 Quartos / Cozinha / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="gov-box" href="https://bit.ly/govpe06">
                        ...
                        <div class="gov-box-caption">
                            <div class="gov-box-caption-content">
                                <div class="project-name">
                                    Tour Virtual 360 ( Casa Modelo 06 )
                                    Casa Com 2 Quartos / Cozinha / Are&#225; de servi&#231;o / garagem
                                </div>
                            </div>
                        </div>
                                ...
                                <a class="gov-box" href="https://bit.ly/govpe07">
                                    ...
                                    <div class="gov-box-caption">
                                        <div class="gov-box-caption-content">
                                            ...
                                            <div class="project-name">
                                                Tour Virtual 360 ( Casa Modelo 07 )
                                                Casa Com 2 Quartos / Cozinha Americana / Are&#225; de servi&#231;o / garagem
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <a class="gov-box" href="https://bit.ly/govpe08">
                                    ...
                                    <div class="gov-box-caption">s
                                        <div class="gov-box-caption-content">
                                            <div class="project-name">
                                                Tour Virtual 360 ( Casa Modelo 08 )
                                                Casa Com 3 Quartos / Cozinha Americana / Are&#225; de servi&#231;o / garagem / 1 Quarto Com Suite
                                            </div>
                                        </div>
                                    </div>
                                </a>
